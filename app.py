...
model = joblib.load('random_forest_best.joblib')  # Ganti dengan model yang sesuai
...
MTRANS = st.selectbox("Jenis transportasi apa yang biasa Anda gunakan?", ["Walking", "Public_Transportation", "Automobile", "Bike", "Motorbike"])
